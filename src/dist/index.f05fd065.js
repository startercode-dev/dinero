...
})({"10i0s":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "964a5435f05fd065";
"use strict";
...
const documentHeight = ()=>{
    ...
    const height = window.innerHeight - (0, _jqueryDefault.default)(".header").outerHeight();
...
const clickScroll = (className, section)=>{
    ...
    (0, _jqueryDefault.default)(`.${className}`).on("click", ()=>{
        (0, _jqueryDefault.default)(`.${section}`)[0].scrollIntoView({
            behavior: "smooth"
        });
    });
};
...
const loadAnimations = (threshold)=>{
    ...
    const loadSection = (elem)=>{
        if (elem.hasClass("section--hidden")) elem.removeClass("section--hidden");
    };
    const setAnimationObserver = (elem)=>{
        const sectionObserver = new IntersectionObserver((entries)=>{
            const [entry] = entries;
            if (entry.intersectionRatio >= threshold) loadSection(elem);
        }, {
            threshold
        });
        sectionObserver.observe(elem[0]);
    };
    (0, _jqueryDefault.default)(".animate").each((i, elem)=>{
        (0, _jqueryDefault.default)(elem).addClass("section--hidden");
        setAnimationObserver((0, _jqueryDefault.default)(elem));
    });
};
loadAnimations(0.3);
//---------------------------------
// NAV BAR MOBILE
//---------------------------------
(0, _jqueryDefault.default)(".mobile-nav-btn").click(()=>{
    (0, _jqueryDefault.default)(".header__mobile-menu").toggleClass("show");
    (0, _jqueryDefault.default)(".header").toggleClass("fixed-top");
    (0, _jqueryDefault.default)(".mobile-nav-btn i").toggleClass("ph-x");
    (0, _jqueryDefault.default)(".mobile-nav-btn i").toggleClass("ph-list-light");
    (0, _jqueryDefault.default)("body").toggleClass("pt-53");
});
(0, _jqueryDefault.default)(window).resize(()=>{
    const condition = (0, _jqueryDefault.default)(".header").hasClass("fixed") || (0, _jqueryDefault.default)(".header__mobile-menu").hasClass("show") || (0, _jqueryDefault.default)(".hero").hasClass("pt-35") ? true : false;
    if ((0, _jqueryDefault.default)(window).width() >= 520 && condition) {
        (0, _jqueryDefault.default)(".header").removeClass("fixed");
        (0, _jqueryDefault.default)(".header__mobile-menu").removeClass("show");
        (0, _jqueryDefault.default)(".hero").removeClass("pt-35");
        if ((0, _jqueryDefault.default)(".mobile-nav-btn i").hasClass("ph-x")) {
            console.log(true);
            (0, _jqueryDefault.default)(".mobile-nav-btn i").toggleClass("ph-list-light");
            (0, _jqueryDefault.default)(".mobile-nav-btn i").toggleClass("ph-x");
        }
...
},{}]},["10i0s","ebWYT"], "ebWYT", "parcelRequire708b")

//# sourceMappingURL=index.f05fd065.js.map
